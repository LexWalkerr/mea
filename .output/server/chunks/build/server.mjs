...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CMEjvjFE.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-Bk5nlTID.mjs')
  },
  {
    name: "payment",
    path: "/payment",
    component: () => import('./payment-kXomwv1C.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DBb_zaiS.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BDs8uo_p.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BObVfodo.mjs'));
